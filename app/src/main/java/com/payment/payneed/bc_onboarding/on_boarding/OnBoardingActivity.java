package com.payment.payneed.bc_onboarding.on_boarding;
...
import com.payment.payneed.databinding.ActivityOnBoardingBinding;
...
//            ExtensionFunction.checkValidation(dobEt, "Date Of Birth Required");
            ...
            return false;
        } else if (pan.isEmpty() || !panPattern.matcher(pan).matches()) {
