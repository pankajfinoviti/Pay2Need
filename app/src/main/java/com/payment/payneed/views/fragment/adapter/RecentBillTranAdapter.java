package com.payment.payneed.views.fragment.adapter;
...
public class RecentBillTranAdapter extends RecyclerView.Adapter<RecentBillTranAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        String txt = "";
        if (model.getStatus().equalsIgnoreCase("failed")){
            txt = "Recharge of " + MyUtil.formatWithRupee(mContext, model.getAmount()) + " failed on " + model.getCreatedAt();

        }else{
            txt = "Recharge of " + MyUtil.formatWithRupee(mContext, model.getAmount()) + " done on " + model.getCreatedAt();
