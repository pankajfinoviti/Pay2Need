package com.payment.payneed.views.browseplan;
...
import com.payment.payneed.views.browseplan.adapter.PlanAdapter;
import com.payment.payneed.views.browseplan.listen.PlanSelectorLis;
...
public class ViewPlans extends AppCompatActivity implements RequestResponseLis,
    ...
    private String planValue, planDetail, circle;
