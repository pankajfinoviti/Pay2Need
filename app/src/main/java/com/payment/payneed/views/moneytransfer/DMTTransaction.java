package com.payment.payneed.views.moneytransfer;
...
import com.payment.payneed.views.invoice.model.LocalInvoiceModel;
    ...
    public void onSuccessRequest(String JSonResponse) {
        try {
            ...
            for (LocalInvoiceModel model : dataList) {
                Constants.INVOICE_DATA.add(new InvoiceModel("RRN", model.getRrn()));
                ...
                Constants.INVOICE_DATA.add(new InvoiceModel("Message", model.getMessage()));
